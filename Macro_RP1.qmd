...
The reduced form of the model allows for estimation where $B_0^{-1}$ is the matrix of contemporaneous effects between variables. The identification strategy for $B_0^{-1}$ is yet to be finalized, but will likely involve either exclusion restrictions or sign restrictions.
