...
#### Time series plots: 1990 Q1 to 2022 Q4, original values {style="text-align: center;"}
...
#### Autocorrelation function (ACF) plots {style="text-align: center;"}
...
#### Partial autocorrelation function (PACF) plots {style="text-align: center;"}
...
#### ADF test results: levels, first, and second difference {style="text-align: center;"}
